...
int addRelation(Graph *g, char vertice1, char vertice3){
    int posVertice1=findVertice(g->elements,g->noElements,vertice1);
    int posVertice3=findVertice(g->elements,g->noElements,vertice3);
    if(posVertice1!=-1 && posVertice3!=-1){
        g->matrix[posVertice1][posVertice3]=1;
        g->matrix[posVertice3][posVertice1]=1;
        return 1;
    }
    return 0;
}
